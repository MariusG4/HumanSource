...
function TestimonialCard({ img, rating, feedback, client, title }: any) {
	return (
		<Card color="transparent" shadow={false} className=" flex h-full max-w-3xl bg-gri-deschis-bg bg-opacity-25 p-8 ">
